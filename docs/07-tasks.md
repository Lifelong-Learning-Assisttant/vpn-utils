...
| Этап | Оценка времени |
|------|----------------|
| Этап 1: Инфраструктура | 30 минут |
| Этап 2: VPN контейнер | 3-4 часа |
| Этап 3: Dev контейнер | 2-3 часа |
| Этап 4: Приложения | 2-3 часа |
| Этап 5: Тестирование | 2-3 часа |
| Этап 6: Документация | 2-3 часа |
| **Итого** | **11.5-16.5 часов** |
...
2. **Этап 2 (P0):** Создать и протестировать VPN контейнер
